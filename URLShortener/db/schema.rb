...
ActiveRecord::Schema.define(version: 20160526004840) do
  ...
  add_index "clicks", ["short_url"], name: "index_clicks_on_short_url"
  ...
  add_index "taggings", ["topic_id", "short_url"], name: "index_taggings_on_topic_id_and_short_url", unique: true
